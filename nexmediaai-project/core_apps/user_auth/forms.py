...
from django_recaptcha.widgets import ReCaptchaV2Checkbox  # For visible checkbox
User = get_user_model()
...
class CustomRegistrationForm(forms.Form):
    ...
    # Add reCAPTCHA field - OPTION 1: v2 Checkbox (visible)
    # captcha = ReCaptchaField(
    #     widget=ReCaptchaV2Checkbox(
    #         attrs={
    #             'data-theme': 'dark',  # 'light' or 'dark'
    #             'data-size': 'normal',  # 'compact' or 'normal'
    #         }
    #     )
    # )
    
    # OPTION 2: Uncomment below and comment above for v3 (invisible)
    # captcha = ReCaptchaField(
    #     widget=ReCaptchaV3(
    #         attrs={
    #             'required_score': 0.85,
